...
const SearchField: React.FC = () => {
	...
	return (
		<div className="search-field">
			...
			{value && (
				<svg onClick={onClickClear} className="search-field__clear" enable-background="new 0 0 128 128" height="128px" id="Layer_1" version="1.1" viewBox="0 0 128 128" width="128px" xmlns="http://www.w3.org/2000/svg">
					<g>
						<g>
