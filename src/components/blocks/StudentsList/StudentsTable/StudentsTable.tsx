...
const StudentsTable: React.FC<StudentElement> = ({ id, name, specialty, group, birthday, rating, color, avatar }) => {
	...
	return (
		<tr key={id} className="students-table__item">
			<td className="students-table__item-text">
				<div className="students-table__item-avatar">
					<img className="" src={avatar} alt="" />
				</div>
			</td>
			<td className="students-table__item-text">{name}</td>
			<td className="students-table__item-text">{specialty}</td>
			<td className="students-table__item-text">{group}</td>
			<td className="students-table__item-text">{age}</td>
			<td className="students-table__item-text">{rating}</td>
			<td className="students-table__item-color">
				<div className="students-table__item-color-shape" style={{ backgroundColor: color }} title={color}></div>
			</td>
			<td className="students-table__item-text">
				<div onClick={handleDelete} className="students-table__item-delete ">
