			...
			<div className="students-card">
				<div className="students-card__header">
					<div className="students-card__student">
						<div className="students-card__avatar">
							<img src="https://fra1.digitaloceanspaces.com/front-assignment-api/avatar_1.jpg" alt="" />
						</div>
						<div className="students-card__info">
							<h2 className="students-card__info-name">Name Surname</h2>
							<div className="students-card__info-more">
								<div className="students-card__info-color">
									<div className="students-card__info-color-shape" style={{ backgroundColor: "red" }} title="red"></div>
								</div>
								<div className="students-card__info-rating">
									...
									<p className="students-card__info-rating-ratio">56</p>
								</div>
							</div>
						</div>
					</div>
					<div className="students-card__delete">
				...
				<div className="students-card__body">
					<ul className="students-card__list">
						<li className="students-card__list-item">21 yo</li>
						<li className="students-card__list-item">Speciality</li>
